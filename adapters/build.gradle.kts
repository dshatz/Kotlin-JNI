...
kotlin {
    ...
    sourceSets {
        ...
        val jniNativeMain = getByName("jniNativeMain") {
            dependencies {
...
mavenPublishing {
    ...
    pom {
        name.set("Kotlin-JNI JniAdapter")
        description.set("Adapter definitions for Kotlin-JNI KSP processor.")
